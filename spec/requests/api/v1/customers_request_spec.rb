...
# binding.pry
  ...
  describe 'biz intel methods' do
    before :each do
      ...
      @invoice1 = @customer.invoices.create!(status: 'shipped', merchant_id: @merch5.id, created_at: '2019-02-07 12:54:24 -0500', updated_at: '2019-02-07 12:54:24 -0500')
      @invoice2 = @customer.invoices.create!(status: 'shipped', merchant_id: @merch5.id, created_at: '2019-02-07 12:54:24 -0500', updated_at: '2019-02-07 12:54:24 -0500')
      @invoice3 = @customer.invoices.create!(status: 'shipped', merchant_id: @merch5.id, created_at: '2019-02-08 12:54:24 -0500', updated_at: '2019-02-08 12:54:24 -0500')
      @invoice4 = @customer.invoices.create!(status: 'shipped', merchant_id: @merch5.id, created_at: '2019-02-08 12:54:24 -0500', updated_at: '2019-02-08 12:54:24 -0500')
      ...
      @invoice6 = @customer.invoices.create!(status: 'shipped', merchant_id: @merch6.id, created_at: '2019-02-10 12:54:24 -0500', updated_at: '2019-02-10 12:54:24 -0500')
      @invoice7 = @customer.invoices.create!(status: 'shipped', merchant_id: @merch6.id, created_at: '2019-02-11 12:54:24 -0500', updated_at: '2019-02-11 12:54:24 -0500')
      @invoice8 = @customer.invoices.create!(status: 'shipped', merchant_id: @merch6.id, created_at: '2019-02-12 12:54:24 -0500', updated_at: '2019-02-12 12:54:24 -0500')
      @invoice9 = @customer.invoices.create!(status: 'shipped', merchant_id: @merch6.id, created_at: '2019-02-13 12:54:24 -0500', updated_at: '2019-02-13 12:54:24 -0500')
    ...
    it 'can find a customers fave merchant' do
      get "/api/v1/customers/#{@customer.id}/favorite_merchant"

      merchant = JSON.parse(response.body)
      expect(merchant["data"]["attributes"]["id"]).to eq(@merch5.id)
      expect(merchant["data"]["attributes"]["name"]).to eq(@merch5.name)
    end
  end
end
